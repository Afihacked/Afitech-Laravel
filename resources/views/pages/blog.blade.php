...
<section class="section-padding relative overflow-hidden py-24">
  <div class="container-afitech">
    ...
    <div class="mt-14 grid gap-8 lg:grid-cols-3">
      @foreach ([
      ['title' => 'Membangun platform digital scalable', 'summary' => 'Prinsip arsitektur yang memudahkan evolusi produk tanpa mengorbankan performa.', 'tag' => 'Architecture'],
      ...
      ['title' => 'Mengirim produk lebih cepat dengan pipeline modern', 'summary' => 'Langkah-langkah praktis untuk penerapan proses delivery yang lebih ramping.', 'tag' => 'Delivery'],
      ] as $post)
      <article class="glass rounded-[2rem] border border-white/10 p-8 shadow-xl dark:bg-slate-950/80">
        ...
        <a href="#" class="mt-6 inline-flex items-center gap-2 text-sm font-semibold text-cyan-500 hover:text-cyan-400">Read more
