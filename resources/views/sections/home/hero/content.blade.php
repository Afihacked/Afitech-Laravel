<div class="max-w-2xl">
  ...
  {{-- ==========================================================
    ...
    =========================================================== --}}
  <div
    class="hero-badge inline-flex items-center gap-2 rounded-full border border-white/60 bg-white/70 px-5 py-2 text-sm font-medium text-slate-600 shadow-sm backdrop-blur-xl dark:border-white/10 dark:bg-white/10 dark:text-slate-200">
  ...
  <div class="mt-8">
    ...
    <p class="hero-description mt-8 max-w-xl text-lg leading-8 text-slate-600 dark:text-slate-300 sm:mt-10 sm:text-xl sm:leading-9">
      ...
      modern, aman, dan siap berkembang bersama kebutuhan Anda.
