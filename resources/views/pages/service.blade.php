  ...
  <div class="container-afitech">
    <div class="grid gap-14 lg:grid-cols-[.95fr_1.05fr] lg:items-center">
      <div class="max-w-3xl">
        ...
        <div class="mt-10 space-y-6">
          <div class="glass rounded-[2rem] border border-white/10 bg-slate-950/10 p-8 shadow-2xl dark:bg-slate-900/70">
            <h2 class="text-xl font-semibold text-slate-950 dark:text-white">Overview</h2>
      ...
      <div class="glass rounded-[2rem] border border-white/10 bg-white/80 p-10 shadow-2xl dark:bg-slate-950/80">
        <p class="text-sm uppercase tracking-[0.22em] text-cyan-300">What we deliver</p>
        <div class="mt-8 space-y-6">
          ...
          <div class="rounded-3xl border border-white/10 bg-slate-950/5 p-6 dark:border-white/10 dark:bg-slate-900/50">
            <p class="text-slate-600 dark:text-slate-300">Setiap layanan kami dibangun berdasarkan pengalaman praktis dan best practice engineering terkini.</p>
          </div>
          <div class="rounded-3xl border border-white/10 bg-slate-950/5 p-6 dark:border-white/10 dark:bg-slate-900/50">
            <p class="text-slate-600 dark:text-slate-300">Kami membantu Anda mendefinisikan roadmap fitur, desain, dan delivery agar cepat ke pengguna.</p>
          </div>
        </div>
