  ...
  <div class="container-afitech">
    <div class="grid gap-12 lg:grid-cols-[1.05fr_.95fr] lg:items-center">
      ...
      <div class="glass rounded-[2rem] border border-white/10 bg-slate-950/10 p-10 shadow-2xl dark:bg-slate-900/70">
        <p class="text-sm uppercase tracking-[0.22em] text-cyan-300">Mengapa Afitech</p>
        <div class="mt-8 space-y-5">
          ...
          <div class="rounded-3xl border border-white/10 bg-white/80 p-6 shadow-sm dark:bg-slate-950/80">
            <h3 class="text-lg font-semibold text-slate-950 dark:text-white">Kualitas teknis</h3>
            <p class="mt-2 text-slate-600 dark:text-slate-300">Kode bersih, arsitektur yang siap dikembangkan, dan pengujian untuk stabilitas.</p>
          </div>
          <div class="rounded-3xl border border-white/10 bg-white/80 p-6 shadow-sm dark:bg-slate-950/80">
            <h3 class="text-lg font-semibold text-slate-950 dark:text-white">Dukungan lanjutan</h3>
            <p class="mt-2 text-slate-600 dark:text-slate-300">Pendampingan setelah peluncuran agar platform tetap berjalan lancar seiring pertumbuhan bisnis.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="mt-16 grid gap-6 lg:grid-cols-[1fr_1fr]">
      <div class="glass rounded-3xl border border-white/10 p-10 shadow-xl dark:bg-slate-950/80">
        ...
        <p class="mt-4 text-slate-600 dark:text-slate-300">Tim teknis dan desain kami fokus membangun produk digital yang jelas tujuannya dan mudah dipelihara.</p>
        <ul class="mt-6 space-y-3 text-slate-600 dark:text-slate-300">
          ...
          <li>- Ahli cloud dan otomasi</li>
        </ul>
      </div>
      <div class="glass rounded-3xl border border-white/10 p-10 shadow-xl dark:bg-slate-950/80">
        <h2 class="text-2xl font-semibold text-slate-950 dark:text-white">Nilai yang kami pegang</h2>
        <ul class="mt-6 space-y-3 text-slate-600 dark:text-slate-300">
